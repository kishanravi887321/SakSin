...
class LangChainConfig:
    ...
    def get_random_api_key(cls):
        ...
        print(f'🎲🎲 selected GOOGLE_API_KEY_{index} ....🎲🎲', keys[index])
        return keys[index]
    ...
    def get_llm_config(cls) -> Dict[str, Any]:
        """Get LLM-specific configuration for compatibility"""
...
try:
    ...
    print("💡 Please set the GOOGLE_API_KEY environment variables")